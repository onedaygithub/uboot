...
ctc5236_ddr_cfg_t ddr_config_e530_48t4x2q = {
	...
	.ddrintf_wrlvl_delay_db0 = 292,
	.ddrintf_wrlvl_delay_db1 = 303,
	.ddrintf_wrlvl_delay_db2 = 172,
	...
	.system_mem_size = SYSTEM_MEM_2GB,
};
...
int ctc_init_dram(void)
{
	phys_size_t dram_size;
        ...
        dram_size = ctc_ddr_init(&ddr_config_e530_48t4x2q);
#else
