...
void e530_48t_i2c_cfg(void)
{
	int i2cbus = 0;
	cmd_i2c_set_bus_num(i2cbus);
	/* Lcm cfg i2c to gpio for 48t4x2q */
	ctc_i2c_mw(0x21, 0x2, 0xf0);
	ctc_i2c_mw(0x21, 0x3, 0xff);
	ctc_i2c_mw(0x21, 0x6, 0x0);
	ctc_i2c_mw(0x21, 0x7, 0x3f);
	
	ctc_i2c_mw(0x22, 0x2, 0x76);
	ctc_i2c_mw(0x22, 0x3, 0x0);
	ctc_i2c_mw(0x22, 0x6, 0x0);
	ctc_i2c_mw(0x22, 0x7, 0x3f);
}
