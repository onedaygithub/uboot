...
void e530_48x_i2c_cfg(void)
{
	...
	ctc_i2c_mw(0x22, 0x8, 0x0);
	ctc_i2c_mw(0x22, 0xc, 0x0);

	ctc_i2c_mw(0x74, 0x0, 0x2);
	
	ctc_i2c_mw(0x23, 0x18, 0x0);
	ctc_i2c_mw(0x23, 0x19, 0xff);
	ctc_i2c_mw(0x23, 0x1a, 0xff);
	ctc_i2c_mw(0x23, 0x1b, 0xff);
	ctc_i2c_mw(0x23, 0x1c, 0x0);
	ctc_i2c_mw(0x23, 0x20, 0xff);
	ctc_i2c_mw(0x23, 0x21, 0xff);
	ctc_i2c_mw(0x23, 0x22, 0xff);
	ctc_i2c_mw(0x23, 0x23, 0xff);
	ctc_i2c_mw(0x23, 0x24, 0xff);
	ctc_i2c_mw(0x23, 0x8, 0x0);
	ctc_i2c_mw(0x23, 0xc, 0x0);

	ctc_i2c_mw(0x24, 0x18, 0x0);
	ctc_i2c_mw(0x24, 0x19, 0xff);
	ctc_i2c_mw(0x24, 0x1a, 0xff);
	ctc_i2c_mw(0x24, 0x1b, 0xff);
	ctc_i2c_mw(0x24, 0x1c, 0x0);
	ctc_i2c_mw(0x24, 0x20, 0xff);
	ctc_i2c_mw(0x24, 0x21, 0xff);
	ctc_i2c_mw(0x24, 0x22, 0xff);
	ctc_i2c_mw(0x24, 0x23, 0xff);
	ctc_i2c_mw(0x24, 0x24, 0xff);
	ctc_i2c_mw(0x24, 0x8, 0x0);
	ctc_i2c_mw(0x24, 0xc, 0x0);
}
