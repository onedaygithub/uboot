...
ctc5236_ddr_cfg_t ddr_config_e530_48m4y2d = {
	...
	.ddrintf_wrlvl_delay_db0 = 322,
	.ddrintf_wrlvl_delay_db1 = 329,
	.ddrintf_wrlvl_delay_db2 = 98,
...
int ctc_init_dram(void)
{
	phys_size_t dram_size;
        ...
        dram_size = ctc_ddr_init(&ddr_config_e530_48m4y2d);
#else
