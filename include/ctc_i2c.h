...
#define CTC_I2C0_BASE		0x33700000
#define CTC_I2C1_BASE		0x33701000

#define CTC_IC_INTR_RD_REQ	0x020
#define CTC_IC_INTR_RX_FULL	0x004

extern int i2c_ctc_reg_slave(int dev);
extern int i2c_ctc_send_data(int val);
extern int i2c_ctc_receive_data(void);
