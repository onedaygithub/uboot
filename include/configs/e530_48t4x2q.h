...
#ifndef __E530_48T4X2Q_H
#define __E530_48T4X2Q_H
...
/*2GB*/
#define CONFIG_SYS_SDRAM_SIZE		0x80000000UL /* SDRAM SIZE 2GB*/
...
/**************************************************************************/
#define CONFIG_EXTRA_ENV_SETTINGS  "uImageboot=bootm ${loadaddr}#e530-48t4x2q\0" \
									"uImageload=ext4load mmc 0:2 ${loadaddr} uImage\0" \
									"product_series=e530\0" \
									"board_type=48t4x2q\0" \
									"serialno=N/A\0" \
