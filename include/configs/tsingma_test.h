...
#define CONFIG_SYS_SDRAM_SIZE		0x40000000UL /* SDRAM MAX SIZE 2GB for Uboot */
...
/**************************************************************************/
#define CONFIG_EXTRA_ENV_SETTINGS  "uImageboot=bootm ${loadaddr}#tsingma-test\0" \
									"uImageload=ext4load mmc 0:2 ${loadaddr} uImage\0" \
									"product_series=tsingma\0" \
									"board_type=test\0" \
									"serialno=N/A\0" \
									"eth=ethernet@33410000\0" \
									"eth1=ethernet@33420000\0" \
									"ethact=ethernet@33420000\0" \
