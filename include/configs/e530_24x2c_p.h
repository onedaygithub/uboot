...
#ifndef __E530_24X_P_H
#define __E530_24X_P_H
...
#define CONFIG_RESERVE_MEMORY_START		RESERVE_MEMORY_OFFSET_4GB
...
/* PWM Gpio Multi */
/**************************************************************************/
#define PWM_GpioMulti_MASK 0x0000ffff
...
/**************************************************************************/
#define CONFIG_EXTRA_ENV_SETTINGS  "uImageboot=bootm ${loadaddr}#e530-24x2c-p\0" \
									"uImageload=ext4load mmc 0:2 ${loadaddr} uImage\0" \
									"product_series=e530\0" \
									"board_type=24x2c-p\0" \
									"serialno=N/A\0" \
