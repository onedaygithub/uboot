...
#define CTCMAC_UINIT_BASE      0x33400000
...
/*Field*/
/*CTCMAC_INIT*/
#define CI_INIT  0x00000001
/*CTCMAC_SGMII_AUTO_CFG*/
#define CSA_EN  0x00000001
#define CSA_MD  0x0000000c
/*CTCMAC_RESET_CFG*/
#define CRC_TX_RST 0x00000002
#define CRC_RX_RST 0x00000001
/*CTCMAC_DESC_CFG*/
#define CDC_SOP   0x00400000
#define CDC_EOP   0x00800000
...
struct ctcmac_private {
	struct ctcmac_desc_cfg tx_desc[TX_BUF_CNT];
	struct ctcmac_desc_cfg rx_desc0[PKTBUFSRX];
	struct ctcmac_desc_cfg rx_desc1[PKTBUFSRX];
	...
	u8 id;  /*mac index*/
	u32 flags;
	u32 rx_curr_idx0;	/* start index of the current RX buffer */
	u32 rx_curr_idx1;	/* start index of the current RX buffer */
	u32 tx_curr_idx;	/* current index of the TX buffer */
	u32 tx_rcyl_idx;     /* recycle index of the TX buffer */
...
struct ctcmac_status
{
	u32 link_up;
	u32 local_tx_speed;
	u32 local_rx_speed;
	u32 remote_speed;
	struct ctcmac_pkt_stats pkt_stats;
};
...
int ctcmac_get_mac_status(struct CpuMac_regs *cpumac_reg, 
	struct CpuMac_mems *cpumac_mem, struct ctcmac_status* status);
